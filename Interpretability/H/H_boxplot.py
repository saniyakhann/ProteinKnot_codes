...
writhe = pd.read_csv('gradcam_results_writhe_H.csv')
...
ax.set_title('Grad-CAM Diagonal Attention Ratio by CATH Class\n(Writhe CNN, H-level)', fontsize=13, fontweight='bold')
ax.set_ylim(0, 1.15)
ax.grid(axis='y', alpha=0.3)
plt.tight_layout()
plt.savefig('DAR_boxplot_writhe_only_H.png', dpi=200, bbox_inches='tight')
plt.close()
print('saved: DAR_boxplot_writhe_only_H.png')
