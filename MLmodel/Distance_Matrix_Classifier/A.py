...
checkpoint = torch.load("cnn_dist_A_best.pth", map_location=device)
...
plt.title("Confusion Matrix (Distance - A level)", fontsize=16)
plt.xlabel("Predicted", fontsize=12)
plt.ylabel("True", fontsize=12)
plt.tight_layout()
plt.savefig("confusion_matrix_dist_A.png", dpi=200)
plt.close()
...
plt.tight_layout()
plt.savefig('training_curves_dist_A.png', dpi=300)
plt.close()
